...
export const generatePayslipPDF = (data: PayslipData): void => {
  ...
  doc.text('PEMWA PAYROLL SYSTEM', 105, 20, { align: 'center' })
  ...
  // Footer
  doc.setFontSize(8)
  doc.text('Generated by Pemwa Payroll System', 105, 280, { align: 'center' })
...
export const generateRemittancePDF = (data: RemittanceData): void => {
  ...
  // Footer
  doc.setFontSize(8)
  doc.text('Generated by Pemwa Payroll System', 105, 250, { align: 'center' })
...
export const generateP9PDF = (data: P9Data): void => {
  ...
  const row = (label: string, amount: number, showMonthly = false, dy = 8) => {
    ...
    if (showMonthly) {
      ...
      doc.text(`(${formatCurrency(monthly)} × 12)`, amountX, y + 4, { align: 'right' })
      doc.setTextColor(0)
    }
  }
  ...
  // Header
  doc.setFontSize(18)
  doc.text('PEMWA PAYROLL SYSTEM', pageWidth / 2, y, { align: 'center' })
  y += 7
  doc.setFontSize(12)
  ...
  doc.setFontSize(8)
  doc.text('Generated by Pemwa Payroll System', pageWidth / 2, footerY - 3, { align: 'center' })
